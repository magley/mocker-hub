...
class TestDeleteRepo:
    ...
    def test_user_not_permitted(self, registry_service: RegistryService):
        ...
        user_id = 1
        repo.id = 1
        registry_service.access_control_service.has_admin_access.return_value = False
        ...
        registry_service.access_control_service.has_admin_access.assert_called_once_with(user_id, repo.id)
    ...
    def test_delete_repo__integration(self, mock_get_queue):
        ...
        with TestClient(app) as client:
            ...
            add_team_permission(t1["id"], r4["id"], TeamPermissionKind.admin)
