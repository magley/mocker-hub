...
from app.api.org.org_dto import OrganizationCreateDTO, OrganizationDTO
from app.api.org.org_service import OrganizationService, get_org_service

router = APIRouter(prefix="/organizations", tags=["organizations"])

@router.post("/", response_model=OrganizationDTO, status_code=200, summary="Create a new organization")
